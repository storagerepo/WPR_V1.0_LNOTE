	...
	var methods = {
		init : function(options) {
			var defaults = {  
				...
				overlay_y_position: 'top',	// [center, top, bottom] The position of the overlay vertically (if overlay_width is different from width)
				...
				slide_direction: 'top',	// [top, bottom, right, left] From which direction should the overlay apear, for the slide effect only
				zindex: 20,			// The base z-index value
